        ...
        public void UpdateTypesForGetRelated(ModelCode referenceTypeModelCode)
        {
            ...
            switch (referenceTypeModelCode)
            {
                case ModelCode.TERMINAL_REGULATINGCTRL:
                    ReferenceTypes.Add($"{ModelCode.REGULATINGCTRL}", ModelCode.REGULATINGCTRL);
                    OnPropertyChanged("ReferenceType");
                    break;
                ...
                case ModelCode.REGULATINGCTRL_REGULATINGCONDEQ:
                    ReferenceTypes.Add($"{ModelCode.REGULATINGCTRL_REGULATINGCONDEQ}", ModelCode.REGULATINGCTRL_REGULATINGCONDEQ);
                    OnPropertyChanged("ReferenceType");
                    break;
                ...
                case ModelCode.CONTROL_REGULATINGCONDEQ:
                    ReferenceTypes.Add($"{ModelCode.STATICVARCOMP}", ModelCode.STATICVARCOMP);
