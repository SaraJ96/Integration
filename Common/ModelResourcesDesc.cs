...
{	
	...
	public class ModelResourcesDesc
	{
		...
		private void InitializeTypeIdsInInsertOrder()
		{
            ...
            typeIdsInInsertOrder.Add(ModelCode.REGULATINGCTRL);
		...
		{           //globalne i liste referenci
            notSettablePropertyIds.Add(ModelCode.IDOBJ_GID);
            notSettablePropertyIds.Add(ModelCode.TERMINAL_REGULATINGCTRL);
            notSettablePropertyIds.Add(ModelCode.REGULATINGCTRL_REGULATINGCONDEQ);
            notSettablePropertyIds.Add(ModelCode.REACTIVECAPABILITYCURVE_SYNCMACH);
            notSettablePropertyIds.Add(ModelCode.REGULATINGCONDEQ_CTRL);
